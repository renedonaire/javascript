...
//Asigna valor válido
        if (response.originAddresses[0] === "") {
            alert("direccion inicio no válida")
            direccionInicialMap = "";
            return;
        } else {
...
//Asigna valor válido
        if (response.destinationAddresses[0] === "") {
            alert("direccion termino no válida");
            direccionFinalMap = "";
            return;
        } else {
...
function valida() {
    ...
    alert(direccionInicialMap);
    if (direccionInicialMap === "" || parseInt(direccionInicialMap) || !direccionInicialMap) {
    ...
    if (direccionFinalMap === "" || parseInt(direccionFinalMap) || !direccionFinalMap) {
